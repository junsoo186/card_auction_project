	...
	private void initListener() {
		...
		product.get(0).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(0), user, backgroundPanel);
		...
		product.get(1).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(1), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(2).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(2), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(3).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(3), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(4).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(4), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(5).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(5), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(6).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(6), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(7).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(7), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(8).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(8), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(9).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(9), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
		product.get(10).addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				setVisible(false);
				finishedDetailedPanel = new FinishedDetailedPanel(cardList.get(10), user, backgroundPanel);
				backgroundPanel.add(finishedDetailedPanel);
				finishedDetailedPanel.setVisible(true);
			}
		});
